...
public class MainActivity extends AppCompatActivity {
    ...
    // onOptionsItemSelected (11) Override onOptionsItemSelected
    // onOptionsItemSelected (12) Within onOptionsItemSelected, get the ID of the item that was selected
    // onOptionsItemSelected (13) If the item's ID is R.id.action_search, show a Toast and return true to tell Android that you've handled this menu click
    // onOptionsItemSelected (14) Don't forgot to call .show() on your Toast
    // onOptionsItemSelected (15) If you do NOT handle the menu click, return super.onOptionsItemSelected to let Android handle the menu click
}
